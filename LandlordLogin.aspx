<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="LandlordLogin.aspx.cs" Inherits="PropertyRentalContarct.LandlordLogin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%-- <div align="center" style="margin-top:-20px">
        <asp:Image ID="Bnkbanner" runat="server" ImageUrl="~/Images/cirrus-landlord1.jpg" style="width:100%;height:350px"/>
    </div>--%>
    <div align="center" style="margin:10% 5% 0% 0%;width:35%;height:350px; background-color:white">
        <br /><h2><strong>Landlord Login </strong></h2>   
        <br /><br />
        ...
        <div align="center">
          <br /><h4>Not Register Yet ?<a href="LRegister.aspx">Register Here</a></h4><br />
        </div>
    </div>
