<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="LHome.aspx.cs" Inherits="PropertyRentalContarct.AHome" %>
    ...
    <div class="row" style="margin:15px; background-color:beige">         
        ...
        <div class="col-lg-6">
           ...
           <table style="width:100%">
                ...
                <tr>
                    <td><asp:Label ID="Label11" runat="server" Text="Wallet Address :" Font-Bold="true" Font-Size="Large"></asp:Label></td>
