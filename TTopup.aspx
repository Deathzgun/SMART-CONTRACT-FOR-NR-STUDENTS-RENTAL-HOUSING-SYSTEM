<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TTopup.aspx.cs" Inherits="PropertyRentalContarct.TTopup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center" style="background-color:beige">
        ...
        <table style="width:35%; margin-left:6%">
            <tr>
                <td align="right"><asp:Label ID="Label1" runat="server" Text="Tenant-Id :" Font-Size="Large" Font-Bold="true"></asp:Label></td>
                <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="lbtid" runat="server" Text="Label"  Font-Size="Medium"></asp:Label></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
