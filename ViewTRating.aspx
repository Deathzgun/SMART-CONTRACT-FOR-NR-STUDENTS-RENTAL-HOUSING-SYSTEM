<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewTRating.aspx.cs" Inherits="PropertyRentalContarct.ViewTRating" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center"  style="background-color:beige;height:350px;overflow-y:scroll">
        <br />
        <asp:GridView ID="GridView1" CssClass="Gridview" runat="server"  Width="50%" AutoGenerateColumns="false" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="horizontal">           
            <Columns>
                <asp:BoundField DataField="Fid" HeaderText="fDId" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" />
