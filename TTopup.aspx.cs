...
{
    public partial class TTopup : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string qu = "Select status from Tenants where Id='" + tid + "'";
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        lbtid.Text = tid;
                        string q = "Select WalletName, WalletAddr from WalletDetails where LidTid = '" + tid + "'";
  ...
  @"}";
                ...
                if (res.Contains("OK"))
                {
                    ...
                    {
                        con.Open();
                        string qu = "Insert into TopUpRequests values('" + lbtid.Text + "','" + txtwnm.Text + "','" + txtwaddr.Text + "','" + txtamnt.Text + "','Tenant','Done','" + DateTime.Now + "')";
