<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TRegister.aspx.cs" Inherits="PropertyRentalContarct.Register" %>
     ...
     <div id="regDiv" runat="server" visible="true" align="center" style="margin-left:10%">
        ...
        <table width="40%">
            <tr>
                ...
                <td align="center"><asp:TextBox ID="txtId" runat="server" ReadOnly="true" Height="35px" Width="250px" CssClass="form-control"></asp:TextBox></td>
                <td></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
               ...
               <td align="left"><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="check" ErrorMessage="*" ControlToValidate="txtname" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator></td>
            </tr> 
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
...
<tr>
            ...
            <tr>
                ...
                <td align="left"><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  ValidationGroup="check" ErrorMessage="*" ControlToValidate="txtaddr" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator></td>
            </tr> 
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*"  ValidationGroup="check" ControlToValidate="txtemail" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator>&nbsp;
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"  ValidationGroup="check" ErrorMessage="Incorrect Email-Id." ControlToValidate="txtemail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ForeColor="Red" SetFocusOnError="True"></asp:RegularExpressionValidator>
                </td>
            </tr> 
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td align="left"><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"  ValidationGroup="check" ErrorMessage="*" ControlToValidate="txtpassword" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>&nbsp;</td>
                <td align="center">
                    <asp:Button ID="btnreg" runat="server" Font-Size="Medium" Text="Register" CssClass="btn btn-primary"  ValidationGroup="check" OnClick="btnreg_Click"  />
                    <%--<asp:Button ID="btnNext" runat="server" Font-Size="Medium" CssClass="btn btn-primary" Text="Next" OnClick="btnNext_Click" />--%>
                </td>                
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td  align="center"><asp:LinkButton ID="lbtnBack" runat="server" PostBackUrl="~/TenantLogin.aspx"><i class="fa fa-sharp fa-solid fa-arrow-left"></i> Back</asp:LinkButton></td>
                <td>&nbsp;</td>
            </tr>  
        </table>        
        <br />
    ...
    <%--<div id="wallteDiv" runat="server" visible="false" align="center">
        ...
        <table width="28%" style="margin-left:-1%">
            <tr>
                ...
                <td align="left"><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" ControlToValidate="txtwnm" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td align="left"><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ControlToValidate="txtaccnm" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td><asp:Label ID="Label10" Font-Size="Medium" runat="server" Text="Wallet Address :"></asp:Label></td>
            ...
            <tr>
                <td><asp:Label ID="Label9" Font-Size="Medium" runat="server" Text="Wallet Password :"></asp:Label></td>
