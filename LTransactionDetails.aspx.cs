...
{
    public partial class LTransactionDetails : System.Web.UI.Page
    {
        string cs = ConfigurationManager.ConnectionStrings["DbConnect"].ConnectionString;
        string lid, twaddr, twnm, taccname;       
        ...
        protected void GvBind()
        {
            ...
            {
                string q = "Select  WalletAddr, WalletName, AccName from WalletDetails where LidTid = '" + lid + "'";
